        ...
        <div class="main">
            ...
            <div class="search_container">
                <div class="form_container">
                    <form action="healthRecords" method="post">
                ...
                <div class="data_information data_table" style="max-height: 100vh;">
                    ...
                    <table>
                        ...
                        if (isset($_POST['show'])) {
                            ...
                            $year = $_POST['year'];
                            $month = $_POST['month'];
                            $dateApproved = $_POST['date'];
                            

                            $sql = "SELECT * FROM `health_records` WHERE `id_number` = '$idNumber' OR `year`='$year' OR `month`='$month' OR `date_approved`='$dateApproved' ORDER BY last_name";
                    ...
                    elseif (!isset($_POST['show'])){
                        $result = $mysqli->query("SELECT * FROM health_records WHERE approved ='yes' AND year='$years' AND month='$month' ORDER BY last_name");
                        ...
                        while($row = $result->fetch_assoc()){
                            ...
                            <tr>
                                ...
                                <td>
                                    <!-- <a href="./studentHealthForm.php?edit=<?php echo $row['id'];?>" class="btn btn_edit"
                                        id="edit"><i class="fa-solid fa-pen-to-square"></i></a> -->
                                    <a href="./profile?edit=<?php echo $row['id'];?>" class="btn btn_edit" id="edit"><i
                                            class="fa-solid fa-eye"></i> View</a>
                                    <a href="./healthRecords?delete=<?php echo $row['id']; ?>"
                                        onclick="return confirm('Are you sure you want to delete the data')"
                                        class="btn btn_delete" id="btn_modal"><i class="fa-solid fa-trash"></i>
                                        Delete<a>
                                </td>
